...
class Iuvo_Promotion_Block_Promo_Quote_Edit_Tab_Actions extends Mage_Adminhtml_Block_Promo_Quote_Edit_Tab_Actions
{
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('simple_action', 'select', array(
            ...
            'options'    => array(
                ...
                Iuvo_Promotion_Model_Rule::BUY_ITEMX_GET_ITEMY_ACTION => Mage::helper('salesrule')->__('Buy X get Y(s) (Y(s) Added to cart)'),
            ),
        ));
